...
urlpatterns = [
    ...
    url(r'^editar/(?P<user_id>\d+)/agregar-intervencion/$', contractors.add_interv, name='add_interv'),
    url(r'^editar/(?P<user_id>\d+)/editar-intervencion/(?P<interv_id>\d+)$', contractors.edit_interv, name='edit_interv'),
